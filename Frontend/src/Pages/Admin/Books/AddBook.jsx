    ...
    return (
        <main className="form-signin w-11/12 sm:w-10/12  md:w-8/12 lg:w-1/2 m-auto p-5 shadow-xl my-5">
            <form style={{ maxWidth: "400px", margin: "auto" }}>
                ...
                <input type="text" className='w-full text-blue-700 px-5 py-2 border border-blue-900 focus:bg-gray-100' name="book_name" placeholder="Enter book name" required onChange={handleChange} /><br />


                <label>Price:</label>
                <input type="number" className='w-full text-blue-700 pl-12 pr-1 py-2 border border-blue-900 focus:bg-gray-100' name="book_price" placeholder="Enter price" required onChange={handleChange} /><br />


                <label>Description:</label>
                <textarea rows={5} type="description" className='w-full text-blue-700 px-5 py-2 border border-blue-900 focus:bg-gray-100 resize-none' name='book_description' placeholder="Enter description" required onChange={handleChange} /><br />


                <label>Genre:</label>
                <select name="genre" required className='w-full text-blue-700 px-5 py-2 border border-blue-900 focus:bg-gray-100' defaultValue={''} onChange={handleChange} >
