...
return (
    <>
    <div className='bg-[#525862] text-white'>
            <div className="container ">

            <div className="py-5 text-center">
                <img className="d-block mx-auto mb-4" src="/public/Logo.jpg" alt="" width="72" height="57" />
                <h2>Checkout form</h2>
            </div>
            ...
            <div className="row">
                ...
                <div className="col-md-7 col-lg-8">
                   ...
                   <Link to={'/'}><button className="w-100 btn btn-primary btn-lg" type="submit" >Continue to checkout</button></Link>
