...
const ForgetPassword = () => {
    ...
    {showSuccess()} */}
                ...
                <button className='bg-blue-900 hover:bg-blue-500 active:bg-blue-300 text-white active:text-blue-900 px-4 py-2 w-full rounded-md' onClick={handleSubmit}>Send Verification </button>
            </form>
        </>
    )
}
